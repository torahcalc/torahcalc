...
<section>
	...
	<Endpoint
		...
		description="Calculate the Daf Yomi, Nach Yomi, Yerushalmi Yomi, Daily Chofetz Chaim, Daily Rambam Chapter, Daily Shemirat HaLashon, Daily Psalms, Weekly Daf, and Mishnah Yomit for a given date"
		parameters={[
			{
				name: 'date',
				type: 'String',
