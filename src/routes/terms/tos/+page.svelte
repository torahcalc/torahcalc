...
<section>
	...
	<p>
		...
		database rights, and other intellectual property rights related to it, still belong to Fresh
		Idea Inc.
	</p>
	<p>
		Fresh Idea Inc is committed to ensuring that the app is as useful and efficient as possible. For
	...
	<p>
		The TorahCalc app stores and processes personal data that you have provided to us, to provide
		...
		your phone’s security features and it could mean that the TorahCalc app won’t work properly or
		at all.
	</p>
	<!---->
	<p>
		You should be aware that there are certain things that Fresh Idea Inc will not take
		responsibility for. Certain functions of the app will require the app to have an active internet
		connection. The connection can be Wi-Fi or provided by your mobile network provider, but Fresh
		Idea Inc cannot take responsibility for the app not working at full functionality if you don’t
	...
	<p>
		Along the same lines, Fresh Idea Inc cannot always take responsibility for the way you use the
		app i.e. You need to make sure that your device stays charged – if it runs out of battery and
		you can’t turn it on to avail the Service, Fresh Idea Inc cannot accept responsibility.
	</p>
	<p>
		With respect to Fresh Idea Inc’s responsibility for your use of the app, when you’re using the
		...
		make it available to you. Fresh Idea Inc accepts no liability for any loss, direct or indirect,
	...
	<p>
		...
		to keep using the app. Fresh Idea Inc does not promise that it will always update the app so
	...
	<p>
		...
		contact us at jonah@freshidea.com.
	</p>
</section>
