...
<div class="card flex-card">
	...
	<div class="mb-4">
		...
		<ul class="list-unstyled">
			<li><InputExample clickFunction={clickFunction} query="Convert 3 Tefachim to inches." /></li>
			<li><InputExample clickFunction={clickFunction} query="How many Amos are in a Parsah?" /></li>
			<li><InputExample clickFunction={clickFunction} query="Convert 40 Seah to US liquid gallons." /></li>
			<li><InputExample clickFunction={clickFunction} query="Convert 1 US Dollar to Perutos." /></li>
			<li><InputExample clickFunction={clickFunction} query="How many Chalakim are in an hour?" /></li>
			<li><InputExample clickFunction={clickFunction} query="Conversion chart for 1 Mil" /></li>
		</ul>
	...
	<div class="mb-4">
		...
		<ul class="list-unstyled">
			<li><InputExample clickFunction={clickFunction} query="Calculate Gematria of תורה." /></li>
			<li><InputExample clickFunction={clickFunction} query="Calculate Mispar Gadol of מלך." /></li>
			<li><InputExample clickFunction={clickFunction} query="Calculate Mispar Siduri of פרעה." /></li>
			<li><InputExample clickFunction={clickFunction} query="Calculate Mispar Katan Mispari of משיח." /></li>
			<li><InputExample clickFunction={clickFunction} query="Calculate AvGad of משה." /></li>
		</ul>
