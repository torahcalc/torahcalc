...
gregorianDate -> dateOfMonth __ gregorianMonth ", " year {% data => ({year: data[4], month: data[2], day: data[0], format: "DMY"}) %}
               | dateOfMonth __ gregorianMonth {% data => ({month: data[2], day: data[0], format: "DM"}) %}
               | gregorianMonth __ dateOfMonth ", " year {% data => ({year: data[4], month: data[0], day: data[2], format: "MDY"}) %}
...
hebrewDate -> dateOfMonth __ hebrewMonth ", " year {% data => ({year: data[4], month: data[2], day: data[0], format: "DMY"}) %}
            | dateOfMonth __ hebrewMonth {% data => ({month: data[2], day: data[0], format: "DM"}) %}
            | hebrewMonth __ dateOfMonth ", " year {% data => ({year: data[4], month: data[0], day: data[2], format: "MDY"}) %}
