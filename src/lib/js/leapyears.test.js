...
describe('test hebrew leap years', () => {
	it('test non-leap year', () => {
		...
		expect(result.nextLeapYearReason).toBe('After 5781, the next leap year is 5782 – the 6th year of the cycle.');
	});
	...
	it('test leap year', () => {
		...
		expect(result.nextLeapYearReason).toBe('After 5782, the next leap year is 5784 – the 8th year of the cycle.');
	});
	...
	it('test year 19 of the cycle', () => {
		...
		expect(result.nextLeapYearReason).toBe('After 5795, the next leap year is 5798 – the 3rd year of the cycle.');
	});
