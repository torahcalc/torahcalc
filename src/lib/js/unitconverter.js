	...
	return {
		...
		area: {
			...
			units: {
				...
				hectare: { name: 'Hectare', value: 26790750 / 1.55e7, type: 'STANDARD', display: 'hectare', displayPlural: 'hectares' },
				acre: { name: 'Acre', value: 26790750 / 6.273e6, type: 'STANDARD', display: 'acre', displayPlural: 'acres' },
			},
			opinions: {
				rabbi_avraham_chaim_naeh: { name: "Rabbi Avraham Chaim Naeh - ר' אברהם חיים נאה", factor: 1 },
