	...
	return {
		length: {
			...
			units: {
				...
				kaneh: { name: 'Kaneh - קנה', value: 40000 / 3, type: 'BIBLICAL', display: 'Kaneh', displayPlural: 'Kanim' },
		...
		area: {
			...
			units: {
				...
				searah: { name: "Se'arah - שערה", value: 192e7, type: 'BIBLICAL', display: "Se'arah", displayPlural: "Se'aros" },
		...
		weight: {
			...
			units: {
				...
				gerah: { name: 'Gerah - גרה', value: 6e4, type: 'BIBLICAL', display: 'Gerah', displayPlural: 'Gerah' },
		...
		coins: {
			...
			units: {
				...
				gerah: { name: 'Gerah - גרה', value: 12e4, type: 'BIBLICAL', display: 'Gerah', displayPlural: 'Gerah' },
